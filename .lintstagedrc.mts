import { getFileExtensionList, JSLIKE_FILE_EXTENSIONS, PRETTIER_FILE_EXTENSIONS } from '@snailicide/build-config';

//TODO: figure out a way this is not utterly ridiculous
const mdIgnores = ['#**/{node_modules,.changeset,docs}/**', '#packages/cli-template/templates/**/*'];
